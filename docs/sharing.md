...
- shows the note's title and content, including images uploaded to that note (served through a public image endpoint that the token authorizes — see the two `/api/public/...` rows in the [API contract summary](./api.md));
